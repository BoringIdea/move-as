        ...
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-800 font-medium">{new Date(Number(schema.created_at * 1000)).toUTCString()}</p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="text-gray-800 font-medium">
                    {schema.resolver != '0x0' ? schema.resolver : 'No Resolver'}
                  </div>
                </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-blue-100/30 p-6 md:p-8">
            ...
            <div className="p-6 border border-gray-200/50 rounded-xl bg-gray-50/70">
              <pre className="text-sm whitespace-pre-wrap text-gray-700 font-mono">{schemaRawString}</pre>
            </div>
          </div>
